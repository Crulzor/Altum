...
Core/Src/custom_classes/%.o Core/Src/custom_classes/%.su: ../Core/Src/custom_classes/%.cpp Core/Src/custom_classes/subdir.mk
...
Core/Src/custom_classes/%.o Core/Src/custom_classes/%.su: ../Core/Src/custom_classes/%.c Core/Src/custom_classes/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32G484xx -c -I../Core/Inc -I../Drivers/STM32G4xx_HAL_Driver/Inc -I../Drivers/STM32G4xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32G4xx/Include -I../Drivers/CMSIS/Include -I../USB_Device/App -I../USB_Device/Target -I../Middlewares/ST/STM32_USB_Device_Library/Core/Inc -I../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc -I"C:/Users/bartc/STM32CubeIDE/workspace_2/Altum/Mavlink_v2" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"

clean: clean-Core-2f-Src-2f-custom_classes

clean-Core-2f-Src-2f-custom_classes:
	-$(RM) ./Core/Src/custom_classes/Convertor.d ./Core/Src/custom_classes/Convertor.o ./Core/Src/custom_classes/Convertor.su ./Core/Src/custom_classes/Initializer.d ./Core/Src/custom_classes/Initializer.o ./Core/Src/custom_classes/Initializer.su ./Core/Src/custom_classes/SBUS.d ./Core/Src/custom_classes/SBUS.o ./Core/Src/custom_classes/SBUS.su ./Core/Src/custom_classes/components.d ./Core/Src/custom_classes/components.o ./Core/Src/custom_classes/components.su ./Core/Src/custom_classes/debugger.d ./Core/Src/custom_classes/debugger.o ./Core/Src/custom_classes/debugger.su ./Core/Src/custom_classes/handlers.d ./Core/Src/custom_classes/handlers.o ./Core/Src/custom_classes/handlers.su
