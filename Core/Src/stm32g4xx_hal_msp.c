...
//prototype for Error handler since I use custom ones in the classes.
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, ADC_LIN3_Pin|ADC_LIN2_Pin|ADC_LIN1_Pin);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP4_MspDeInit 0 */
    ...
    PB0     ------> COMP4_INP
    */
    HAL_GPIO_DeInit(SHUNT_LIN3_GPIO_Port, SHUNT_LIN3_Pin);
  ...
  /* USER CODE END COMP5_MspDeInit 0 */
    ...
    PB13     ------> COMP5_INP
    */
    HAL_GPIO_DeInit(SHUNT_LIN2_GPIO_Port, SHUNT_LIN2_Pin);
  ...
  /* USER CODE END COMP7_MspDeInit 0 */
    ...
    PB14     ------> COMP7_INP
    */
    HAL_GPIO_DeInit(SHUNT_LIN1_GPIO_Port, SHUNT_LIN1_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PA3     ------> OPAMP1_VINM0
    */
    HAL_GPIO_DeInit(GPIOA, SHUNT_MOTOR_Pin|GPIO_PIN_3);
  ...
  /* USER CODE END OPAMP3_MspDeInit 0 */
    ...
    PB2     ------> OPAMP3_VINM0
    */
    HAL_GPIO_DeInit(GPIOB, SHUNT_LIN3_Pin|GPIO_PIN_2);
  ...
  /* USER CODE END OPAMP4_MspDeInit 0 */
    ...
    PB13     ------> OPAMP4_VINP
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_10|SHUNT_LIN2_Pin);
  ...
  /* USER CODE END OPAMP5_MspDeInit 0 */
    ...
    PB15     ------> OPAMP5_VINM0
    */
    HAL_GPIO_DeInit(GPIOB, SHUNT_LIN1_Pin|GPIO_PIN_15);
